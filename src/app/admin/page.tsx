                              ...
                              <div className="space-y-3">
                                {patient.visits.map((visit, idx) => (
                                  <div key={idx} className="bg-orange-50/50 border border-orange-100 p-3 rounded-lg">
                                    ...
                                    <p className="text-gray-800 line-clamp-3 leading-relaxed">"{visit.chief_complaint}"</p>
                                  </div>
                                ))}
                              </div>
                            ) : (
            ...
            <div className="flex gap-2 border-b border-gray-200 pb-2">
              {(['pending', 'verified', 'rejected'] as DoctorFilterState[]).map(status => (
                <button
                  ...
                  className={`px-4 py-2 capitalize font-medium text-sm rounded-t-lg transition w-32 border-b-2 ${
                    docFilter === status 
